...
class StreamingPage extends StatefulWidget {
  ...
  const StreamingPage({Key key, @required this.streaming}) : super(key: key);
...
class _StreamingPageState extends State<StreamingPage> {
  ...
  Future<void> initialize() async {
    ...
    // Join channel
    await _engine.joinChannel(null, widget.streaming.chanelId, null, 0);
  }
  ...
  void _onCallEnd(BuildContext context) {
    _streamingController.endStreaming(widget.streaming.streamerId);
